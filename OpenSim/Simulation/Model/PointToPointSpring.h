...
namespace OpenSim {
    ...
    public:
         ...
         * Spring end points
         */
        void setPoint1(const Station& p1);
        void setPoint2(const Station& p2);
        void getPoint1(const Station& p1);
        const Station& getPoint1() const;
        const Station& getPoint2() const;
        ...
        SimTK::Vec3 getVector(const SimTK::State& state) const;
        double getTension(const SimTK::State& state) const;
        SimTK::Vec3 getForceOnPoint1(const SimTK::State& state) const;
        SimTK::Vec3 getForceOnPoint2(const SimTK::State& state) const;
